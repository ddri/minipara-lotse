---
title: "Notes on Product Management in Open Source"
date: 2020-02-27
draft: false
---
...
My own product management career was a result of participation in a range of internal and upstream open source projects. These ultimately resulted in an opportunity to spin out with funding and focus on building a product full time. The comparison made me realize that, while sponsored corporate programs and certification are great resources, there's also another powerful source of product education and experience.

And we call that open source.

## Managing in the open

Open source in 2020 is undergoing some interesting evolutions that continue to open up opportunities for new participants to provide their skills and perspectives to the community. It's useful to appreciate the earliest eras of open source as something along the lines of a community of curious engineers learning how to share code and collaborate on projects. A great example is [the historical email from a young Linus Torvalds](https://www.linuxfoundation.org/blog/blog/what-we-know-for-sure-on-linuxs-20th-anniversary) about "a hobby" project that would go on to create the Linux ecosystem. This early community collaboration enabled the productization of open source in the enterprise and an associated evolution as the underlying force behind the cloud and the modern web.

While that's more of a useful summary rather than an exhaustive history of things so far, this lens allows us to appreciate not just projects or products, but all of the inputs and efforts that created the industry we now work in. And for those not working in it, at the very least using the technology via the products that it enabled.

## More open source career advice

Holding this macro view in mind, it's no small thing to consider the overall importance of open source in the world. And the responsibility for practitioners to ensure that it best manages to continue learning how to convert that early curiosity and collaboration into real-world impacts. These aren't just hobbies on a mailing list anymore.

This is a mission that encompasses every aspect of design, marketing, support, sales, documentation, diversity, community management, legal, and finance… and the list goes on. Having said all of that, we can now appreciate the importance of a role that often has an outsized impact in ensuring these various contributions and all their requirements and lenses onto the world are happy or, at least, in alignment when it comes to shipping an actual product.
...
Whatever the route you choose, the benefits of being a part of the community that underlies open source is always first and foremost, and the more you get involved, the more opportunities you will find.
